...
def combine(x_train_env_1, x_train_env_2):
    x_train = []
    for item1 in x_train_env_1:
        x_train.append(item1)
    for item2 in x_train_env_2:
...
x_train_1 = unwrap_phase(x_train_1)
label = np.load('our_data_label_1000_270_150.npy',allow_pickle=True)
...
x_train, x_val, x_train_1, x_val_1 = train_test_split(x_train, x_train_1, test_size=0.2, stratify=label, random_state=42)
